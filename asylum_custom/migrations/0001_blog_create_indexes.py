...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BlogPost', fields ['publish_date']
        db.create_index('blog_blogpost', ['publish_date'])

        # Adding index on 'BlogPost', fields ['slug']
        db.create_index('blog_blogpost', ['slug'])

        # Adding index on 'BlogPost', fields ['expiry_date']
        db.create_index('blog_blogpost', ['expiry_date'])


    def backwards(self, orm):
        # Removing index on 'BlogPost', fields ['expiry_date']
        db.delete_index('blog_blogpost', ['expiry_date'])

        # Removing index on 'BlogPost', fields ['slug']
        db.delete_index('blog_blogpost', ['slug'])

        # Removing index on 'BlogPost', fields ['publish_date']
        db.delete_index('blog_blogpost', ['publish_date'])
